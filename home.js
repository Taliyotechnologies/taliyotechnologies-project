...
//  This code animates the letters of headings when they come into view on scroll
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const headings = document.querySelectorAll(".main-heading, .project-heading, .testimonial-heading, .client-heading");
...
// Fullscreen functionality draaaaaaaaaaaaaaaaaag and drrrrrrrroooop
const workspace = document.getElementById('aboutWorkspace');
let zIndexCounter = 1;
...
// Initialize drag for all boxes
document.querySelectorAll('#aboutWorkspace .draggable-box').forEach(makeDraggable);
